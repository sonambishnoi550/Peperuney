        ...
        <div className="md:pt-[30px] pt-4">
            <div className="container max-w-[1300px] mx-auto px-4">
                <div className="flex justify-between">
                    <Link href="#">
                        <Image className="max-sm:w-[120px] cursor-pointer" src="/assets/images/webp/logo.webp" alt="logo-image" width={262} height={75} />
                    </Link>
                    <div className="flex md:gap-10 gap-2">
                        ...
                        <div className="flex gap-2 items-center">
                            <Link className="max-sm:w-[30px] hover:scale-110 transition-all duration-700" target="_blank" href="https://x.com/?lang=en">
                                <Image src="/assets/images/svg/twitter.svg" alt="twitter" width={77} height={67} />
                            </Link>
                            <Link className="max-sm:w-[30px] hover:scale-110 transition-all duration-700" target="_blank" href="https://web.telegram.org/k/">
                                <Image src="/assets/images/svg/telegram.svg" alt="telegram" width={77} height={67} />
                            </Link>
                            <Link className="max-sm:w-[30px] hover:scale-110 transition-all duration-700" target="_blank" href="https://discord.com/channels">
