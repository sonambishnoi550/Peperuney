...
const ClickToEarn = () => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='bg-cover bg-no-repeat bg-center relative max-sm:bg-click-small max-sm:h-[1260px]' id="arcade" style={{ backgroundImage: `url(/assets/images/png/click-bg.webp)` }}>
                ...
                <div className='container sm:pt-[96px] pt-[60px] relative z-10 pb-[128px] justify-center items-center flex lg:items-end lg:justify-end'>
                    <div data-aos="fade-up" className='sm:max-w-[682px] w-full'>
                        <div className='flex justify-center items-center flex-col'>
                            ...
                            <Image className='sm:max-w-[250px] -mt-2 sm:-mt-5 max-w-[195px]' src="/assets/images/png/casino-logo.webp" alt="casino-image" width={250} height={105} />
                        </div>
                        <div className='bg-no-repeat bg-center bg-[length:100%_100%] -mt-[50px]' style={{ backgroundImage: `url(/assets/images/png/casino-bg.webp)` }}>
                        ...
                        <div className='flex flex-col gap-2 sm:hidden justify-center items-center mt-2'>
                            <button className='transition duration-300 transform hover:scale-105'><Image className='max-w-[335px] w-full' src="/assets/images/svg/play-now-two.svg" alt="mini-app" width={335} height={74.78} /></button>
                            <button className='transition duration-300 transform hover:scale-105'><Image className='max-w-[335px] w-full' src="/assets/images/svg/mini-app-two.svg" alt="mini-app" width={335} height={74.78} /></button>
                        </div>
                    </div>
                </div>
            </div>
