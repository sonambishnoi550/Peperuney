...
const PeperuneyMeme = () => {
    return (
        <div className=' bg-cover lg:bg-[length:100%_100%] bg-center bg-no-repeat relative max-sm:bg-mobile-meme max-sm:bg-[length:100%_100%]' style={{ backgroundImage: `url(/assets/images/png/peperuney-meme-bg.webp)` }}>
            <div data-aos="zoom-out-up" className='max-w-[250px] mx-auto pt-12 max-sm:flex items-center flex-col justify-center md:hidden pb-[30px]'>
                ...
                <img className='sm:max-w-[250px] max-w-[184px] text-center -mt-1' src="/assets/images/png/gallery-image.webp" alt="gallery-image" />
            </div>
            <img className='max-w-[678px] sm:block hidden w-full absolute bottom-0 left-0' src="/assets/images/png/meme-men.webp" alt="meme-men" />
            <div className='lg:pt-[207px] sm:pt-5 flex lg:gap-[70px] xl:gap-[100px] gap-12 sm:pb-[151px] 2xl:mx-auto 3xl:max-w-[1920px] w-full 3xl:justify-between'>
                ...
                <div data-aos="zoom-in" className='relative max-w-[820px] overflow-x-hidden'>
                    ...
                    >
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src="/assets/images/png/bulls-image.webp" alt="bulls-image" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src="/assets/images/png/poster-carusel.webp" alt="poster-carusel" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src="/assets/images/png/poster-carusel-two.webp" alt="poster-carusel-two" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img className='w-full h-[250px] md:h-[267px] lg:h-[259px] xl:h-[360px] object-cover' src="/assets/images/png/bulls-image.webp" alt="bulls-image" />
                        </SwiperSlide>
