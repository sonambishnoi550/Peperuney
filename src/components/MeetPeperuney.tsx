...
const MeetPeperuney = () => {
    ...
    return (
        <div className='relative meet-bg bg-sky-200'>
            <Image className='absolute sm:block hidden -top-[2%] w-full max-xl:h-[200px] xl:h-[268px] pointer-events-auto' src="/assets/images/png/meet-layer.webp" alt="meet-layer" width={1508} height={272} />
            <Image src="/assets/images/png/meet-small-layer.webp" className='absolute top-0 h-[200px] sm:hidden block w-full pointer-events-auto' alt="small-layer" width={1118} height={201} />
            <Image className='absolute top-8 sm:hidden block pointer-events-auto' src="/assets/images/png/clouds-image.webp" alt="clouds-image" width={496} height={1216} />
            <div className='container max-w-[1360px] mx-auto lg:pb-[293px] lg:pt-[250px] pt-[200px] px-4'>
                <div className='w-full relative'>
                    <Image className='absolute -top-28 left-0 sm:block hidden pointer-events-auto' src="/assets/images/png/meet-bg.webp" alt="meet-image" width={1320} height={1031} />
                    <div className='lg:flex-row flex-col max-lg:flex-col-reverse flex gap-1 relative z-10'>
                        <div className='lg:w-[44%] flex items-center justify-center relative z-10'>
                            <Image className='max-w-[580px] w-full max-sm:-mt-8 pointer-events-auto' src="/assets/images/png/meet-cartoon-image.webp" alt="meet-cartoon" width={580} height={530} />
                        </div>
                            ...
                            <div className='meet-vector max-sm:bg-meet-small bg-[length:100%_100%] bg-no-repeat bg-center sm:px-7 sm:py-10 px-3'>
                                ...
                                <div className='sm:ps-12 ps-4'>
                                    ...
                                    <div className='flex justify-between max-sm:gap-2 sm:pt-5 items-center sm:pb-4 pb-3'>
                                        <p className='xl:text-[32px] xl:leading-[52px] sm:text-2xl text-[22px] text-[#0E0E0E] schoolbell'>FEELS GREAT MAN!</p>
                                        <button>
