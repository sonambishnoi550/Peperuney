...
const Pizzanomics = () => {
    ...
    return (
        <div className='relative bg-[#DA291C] overflow-hidden max-w-[1440px] mx-auto'>
            ...
            <p className='luckiest absolute left-1/2 -translate-x-1/2 lg:translate-x-0 lg:left-16 xl:left-20 top-[50px] sm:top-4 md:top-[30px] drop-shadow-[10.7px_-10.7px_0px_#FBDB81] text-[#893101] text-[60px] sm:text-[70px] lg:text-[90px] xl:text-[141px] leading-[100%] z-20'>PIZZANOMICS</p>
            <div className='flex lg:flex-row flex-col-reverse justify-between gap-5'>
                ...
                <div className="xl:max-w-[812px] lg:w-full -mx-5 lg:mx-0">
                    <div className='bg-black relative -rotate-3 w-full h-[341px] pb-10 sm:pb-11 flex justify-center items-end xl:-mt-[240px] -mt-[237px] sm:-mt-[225px] lg:-mt-[260px]'>
                        <p className='luckiest font-normal text-[70px] sm:text-[80px] md:text-[85px] xl:text-[135px] leading-[100%] text-white uppercase mb-0.5'>42 BILLION</p>
                    </div>
                    <p className='luckiest text-4xl sm:text-[80px] sm:leading-[80px] font-normal text-white relative my-5 -rotate-3 text-center'>token supply</p>
                </div>
            </div>
            <div className="flex flex-col lg:flex-row justify-between relative lg:-mt-4">
                <div className="bg-black -rotate-[4deg] -mx-7 xl:h-[111px] lg:w-[630px] px-7 my-auto relative z-10">
                    <p className='text-white luckiest font-normal text-[52px] sm:text-[75px] xl:text-[92px] text-center lg:text-left lg:ml-11 leading-[100%] text-nowrap mb-12 lg:mb-2.5 my-2.5'>LP BURNED</p>
                </div>
                <div className="lg:max-w-[942px] lg:w-full relative z-10 -mt-12 lg:mt-0 -mx-10 lg:mx-0">
                    ...
                    <p className='text-[#893101] drop-shadow-[6px_-6px_0px_#FBDB81] absolute left-1/2 top-[20%] -translate-x-1/2 tracking-[0.04em] text-nowrap font-normal text-[60px] sm:text-[80px] xl:text-[115px] leading-[100%] uppercase luckiest'>zero tax</p>
                </div>
                ...
                <div className="max-sm:bg-mobile-layer bg-100 -mt-[207px] bg-cover bg-no-repeat bg-center min-h-[1190px] pt-[162px]">
                    <div className="flex w-full flex-col lg:flex-row gap-7 sm:gap-12 xl:ml-auto px-5 xl:px-0 xl:mx-11 mx-auto xl:w-fit md:-mb-[200px]">
                        <div className="max-w-[503px] w-full pt-7 mx-auto lg:mx-0 flex flex-col items-center relative z-10">
                            ...
                            <p className='luckiest mt-4 uppercase font-normal text-[52px] sm:text-[80px] text-center leading-[100%] text-white drop-shadow-[6px_6px_0px_#000000]'>bake to earn</p>
