        ...
        <div className='relative bg-[#DA291C] overflow-hidden max-w-[1440px] mx-auto'>
            ...
            <div className='flex lg:flex-row flex-col-reverse justify-between gap-5'>
                <div className='relative z-10 lg:-mt-10 xl:-mt-20 lg:ml-[60px] xl:ml-[67px]'>
                    <Image className='max-w-[301px] sm:max-w-[420px] xl:max-w-[485px] w-full mx-auto lg:mx-0 max-md:pb-4' src="/assets/images/webp/pepe-runny-image.webp" alt="peperunry-image" width={485} height={257.31} />
                </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between relative lg:-mt-4">
                ...
                <div className="lg:max-w-[942px] lg:w-full relative z-10 -mt-12 lg:mt-0 -mx-10 lg:mx-0">
                    <Image src="/assets/images/webp/tax-layer.webp" alt="taxLayer" className='sm:w-full object-cover w-[610px] max-w-[610px] sm:max-w-full' width={942} height={306} />
            ...
            <div className='bg-cover lg:bg-[length:100%_100%] bg-no-repeat bg-center max-sm:bg-mobile-view' style={{ backgroundImage: `url(/assets/images/webp/pizzanomics-bg.webp)` }}>
                <div className="max-sm:bg-mobile-layer bg-100 -mt-[207px] bg-cover bg-no-repeat bg-center min-h-[1190px] pt-[162px]">
                    ...
                    <div className='max-sm:bg-pizzanomics-card bg-cover bg-no-repeat bg-center relative md:pt-[160px] lg:pt-[320px]  max-sm:mt-[184px]' style={{ backgroundImage: `url(/assets/images/webp/cards-pizzanomics-bg.webp)` }}>
                        <div className="flex flex-wrap justify-center lg:flex-nowrap lg:flex-row mx-auto max-w-[1240px] w-full px-5 gap-10 xl:gap-[60px] pb-[75px] sm:pb-8 pt-10 pizzanomics-gradient">
                            <Image src="/assets/images/webp/coin-gecko.webp" alt="coin" className='lg:w-[30%] md:w-[340px] w-[236px] object-contain h-[92px] sm:h-auto sm:w-[280px]' width={360} height={140} />
                            <Image src="/assets/images/webp/dex-screener.webp" alt="dexScreener" className='lg:w-[30%] md:w-[340px] w-[236px] object-contain h-[92px] sm:h-auto sm:w-[280px]' width={360} height={140} />
                            <Image src="/assets/images/webp/dex-tools.webp" alt="dexTools" className='lg:w-[30%] md:w-[340px] w-[236px] object-contain h-[92px] sm:h-auto sm:w-[280px]' width={360} height={140} />
                        </div>
                    </div>
                </div>
            </div>
